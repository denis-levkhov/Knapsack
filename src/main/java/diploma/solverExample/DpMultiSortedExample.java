...
public class DpMultiSortedExample {


    public static Result solveWithSortingStrategies(int n, int capacity, int[] weights, int[][] P) {
        ...
        for (Comparator<Integer> strategy : strategies) {
            ...
            Result current = solveDP(order, capacity, weights, P);
    ...
    public static void main(String[] args) {
        ...
        Result result = solveWithSortingStrategies(n, capacity, weights, P);
        System.out.println("Best profit with sorting heuristics: " + result.getProfit());
